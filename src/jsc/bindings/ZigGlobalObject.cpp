...
static JSSourceCode* fetchSourceSync(Zig::GlobalObject* globalObject, JSModuleLoader* loader, const Identifier& key)
{
    ...
    JSValue result = Bun::fetchESMSourceCodeSync(globalObject, Bun::moduleGraphOfLoader(globalObject, loader), jsString(vm, key.string()), &res, &keyBun, &source, nullptr, false);
    RETURN_IF_EXCEPTION(scope, nullptr);
